...
export const p1295Definition: PatternDefinition = {
  ...
  description: `This calculator generates a machine knitting pattern for a classic V-neck sweater according to your gauge and desired measurements, based on 1295 Men's Classical from <a href="http://machineknittingetc.com/passap-03-pattern-book.html">Passap Model Book 3</a>. Please refer to the original pattern for further instructions.`,
